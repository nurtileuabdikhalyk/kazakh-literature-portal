...
const tracks = ref([
  {
    id: 1,
    title: 'Қараңғы түнде тау қалғып',
    ...
    lines: [
      { time: 0,   words: [
          { text: 'Қараңғы' }, { text: 'түнде' }, { text: 'тау' }, { text: 'қалғып,' },
        ]},
      { time: 8,   words: [
          { text: 'Ұйқыға' }, { text: 'кетер' }, { text: 'далбаса.' },
        ]},
      { time: 16,  words: [
          { text: 'Жел' }, { text: 'тұрса' }, { text: 'оның' }, { text: 'сабалап,' },
        ]},
      { time: 24,  words: [
          { text: 'Ұйқысы' }, { text: 'қашар' },
          { text: 'алғаша', hard: true, def: 'Алғашқы рет, бастапқыда', example: 'Алғаша кездескен кезде сусын берді.', tag: 'Кітаби' },
          { text: '.' },
        ]},
      { time: 32,  words: [
          { text: 'Сөнбейді' },
          { text: 'тынбай', hard: true, def: 'Тоқтамай, үзіліссіз', example: 'Тынбай жұмыс істеді.', tag: 'Ауызекі' },
          { text: 'жүрек' }, { text: 'оты,' },
        ]},
      { time: 40,  words: [
          { text: 'Лаулайды' },
          { text: 'маздап', hard: true, def: 'От жалыны сияқты жарқырап жану', example: 'Шам маздап жанды.', tag: 'Поэтикалық' },
          { text: 'өрт' }, { text: 'болып.' },
        ]},
      { time: 50,  words: [
          { text: 'Сол' }, { text: 'оттың' }, { text: 'жалынды' }, { text: 'аясы' },
        ]},
      { time: 58,  words: [
          { text: 'Жылытар' }, { text: 'мені' }, { text: 'осы' }, { text: 'шақ.' },
        ]},
    ],
  },
  {
    ...
    bookmarked: true,
    lines: [
      { time: 0,  words: [{ text: 'Өмір' }, { text: '—' }, { text: 'өзен,' }, { text: 'ағады' }, { text: 'да' }, { text: 'кетеді,' }]},
      { time: 9,  words: [{ text: 'Артынан' }, { text: 'кім' }, { text: 'іздеп' }, { text: 'тауып' }, { text: 'жетеді?' }]},
      { time: 18, words: [
          { text: 'Тіршілік' },
          { text: 'деген', hard: true, def: '«деп аталатын» мағынасын береді', tag: 'Грамматика' },
          { text: 'осы' }, { text: 'бір' }, { text: 'ғажап' },
          { text: 'сыр', hard: true, def: 'Жасырын, терең мән-мағына', example: 'Оның сырын ешкім білмеді.', tag: 'Кітаби' },
          { text: ',' },
        ]},
      { time: 28, words: [{ text: 'Барын' }, { text: 'тауып' }, { text: 'ала' }, { text: 'білген' }, { text: 'кетеді.' }]},
      { time: 38, words: [
          { text: 'Қуаныш' }, { text: 'та' }, { text: 'тез' },
          { text: 'өтеді', hard: true, def: 'Жылдам өтіп кетеді, ұзамайды', tag: 'Поэтикалық' },
          { text: ',' },
        ]},
      { time: 48, words: [{ text: 'Қайғы' }, { text: 'да' }, { text: 'тез' }, { text: 'өтеді.' }]},
    ],
  },
  {
    id: 3,
    title: 'Абай жолы — I тарау',
    ...
    bookmarked: false,
    lines: [
      { time: 0,  words: [{ text: 'Жаз' }, { text: 'ортасы.' }, { text: 'Шілде' }, { text: 'айының' }, { text: 'аяқ' }, { text: 'шені.' }]},
      { time: 10, words: [
          { text: 'Шыңғыс' }, { text: 'жотасының' },
          { text: 'баурайы', hard: true, def: 'Таудың немесе төбенің беткей, еңіс жері', example: 'Таудың баурайында шалғын өсті.', tag: 'Табиғат' },
          { text: 'ойдым-ойдым' },
          { text: 'жайлауға', hard: true, def: 'Жаз маусымында малды жайып, тұратын кең жер', tag: 'Тұрмыс' },
          { text: 'толған.' },
        ]},
      { time: 22, words: [
          { text: 'Кең' }, { text: 'жазыра' }, { text: 'жайлаудың' }, { text: 'арасында' },
          { text: 'ауыл-ауыл' }, { text: 'отау' },
          { text: 'тіккен', hard: true, def: 'Үй немесе шатыр орнату, тігу', tag: 'Ескі сөз' },
          { text: 'топтар' }, { text: 'жатыр.' },
        ]},
      { time: 35, words: [
          { text: 'Ошақтардан' },
          { text: 'аспан', hard: true, def: 'Кең мол аспан, алыс ашық кеңістік', tag: 'Поэтикалық' },
          { text: 'бұрқыраған' },
          { text: 'түтін', hard: true, def: 'Жанып жатқан нәрседен шығатын бу', tag: 'Тұрмыс' },
          { text: 'тынбай' }, { text: 'шығып' }, { text: 'жатыр.' },
        ]},
    ],
  },
  {
    ...
    bookmarked: false,
    lines: [
      { time: 0,  words: [{ text: 'Алтын' }, { text: 'күн' }, { text: 'аспаны,' }]},
      { time: 7,  words: [{ text: 'Алқып' }, { text: 'соққан' }, { text: 'жел' }, { text: 'даласы,' }]},
      { time: 14, words: [
          { text: 'Егіннің' }, { text: 'бас' },
          { text: 'алқасы', hard: true, def: 'Дән өсімдіктерінің масағы', example: 'Бидайдың алқасы бой тіктеді.', tag: 'Ауыл шаруашылығы' },
          { text: ',' },
        ]},
      { time: 21, words: [{ text: 'Менің' }, { text: 'елім,' }, { text: 'менің' }, { text: 'жерім,' }]},
      { time: 28, words: [{ text: 'Гүлім' }, { text: 'менің' }, { text: '—' }, { text: 'Қазақстан!' }]},
    ],
  },
])
...
// Waveform heights (static, visual only)
...
const progressPct = computed(() => {
  ...
  return Math.min((elapsed.value / currentTrack.value.totalSec) * 100, 100)
})

const filteredTracks = computed(() => {
  const q = searchQ.value.toLowerCase()
  return q ? tracks.value.filter(t =>
...
function startTimer() {
  ...
  timer = setInterval(() => {
    if (!currentTrack.value) return
    elapsed.value += playSpeed.value
    if (elapsed.value >= currentTrack.value.totalSec) {
      elapsed.value = currentTrack.value.totalSec
      if (repeat.value) { elapsed.value = 0 }
      else { isPlaying.value = false; nextTrack() }
    }
  }, 1000)
}
...
function seek(e) {
  if (!progressEl.value || !currentTrack.value) return
  const rect = progressEl.value.getBoundingClientRect()
  const pct  = Math.max(0, Math.min((e.clientX - rect.left) / rect.width, 1))
  elapsed.value = Math.round(pct * currentTrack.value.totalSec)
}
...
function toggleBookmark() { if (currentTrack.value) currentTrack.value.bookmarked = !currentTrack.value.bookmarked }

function jumpToLine(i) {
  if (!currentTrack.value) return
  elapsed.value    = currentTrack.value.lines[i]?.time || 0
  activeLine.value = i
}
  ...
  <section class="audio-section">
    ...
    <div class="player-layout">
      ...
      <div class="track-list-panel">
        <div class="tlp-head">
          <span class="tlp-title"><i class="pi pi-headphones" /> Шығармалар</span>
        ...
        <ul class="track-list">
          ...
          >
            <div class="ti-num" :class="{ playing: currentTrack?.id === track.id && isPlaying }">
              <span v-if="!(currentTrack?.id === track.id && isPlaying)" class="ti-index">{{ idx + 1 }}</span>
      ...
      <div class="main-player-panel" v-if="currentTrack">
        ...
        <div class="player-card">
          ...
          <div class="album-art-wrap">
            ...
            <!-- Ambient glow -->
            <div class="album-glow" :style="{ background: `radial-gradient(circle, ${currentTrack.color}33 0%, transparent 70%)` }" />
          </div>
          ...
          <div class="player-info">
            ...
            <div class="player-extras">
              <div class="vol-row">
                ...
                <input
                    ...
                    min="0" max="100" class="vol-slider"
                />
            ...
            <div class="player-actions">
              <button class="pa-btn" @click="toggleBookmark">
              ...
              <button class="pa-btn" @click="showText = !showText">
                ...
                {{ showText ? 'Мәтінді жасыру' : 'Мәтінді көру' }}
              </button>
              <button class="pa-btn">
                <i class="pi pi-share-alt" /> Бөлісу
              </button>
            </div>
          </div>
        </div>
        ...
        <transition name="text-slide">
          <div v-if="showText" class="text-panel">
            <div class="tp-header">
              ...
              <div class="tp-header-right">
                <span class="tp-hint"><i class="pi pi-info-circle" /> Қиын сөзге басыңыз</span>
            ...
            <div class="text-body" :style="{ fontSize: fontSize + 'px' }">
              <!-- Highlighted line synced to audio -->
              <div
            ...
            <transition name="gloss-fade">
              <div
                  v-if="glossWord"
                  class="gloss-card"
                  @click="glossWord = null"
              >
                <div class="gloss-header">
                  <span class="gloss-word">{{ glossWord.text }}</span>
                  <button class="gloss-close"><i class="pi pi-times" /></button>
                </div>
    ...
    <!-- ══ WAVEFORM visualizer (CSS) ═════════════════════ -->
    <div class="waveform-bar" v-if="currentTrack">
      <div
          v-for="i in 60" :key="i"
          class="wf-bar"
...
.tlp-title i { font-size: .8rem; }
.tlp-search {
  display: flex; align-items: center; gap: .5rem;
  background: rgba(255,255,255,.06); border: 1px solid rgba(255,255,255,.1);
  border-radius: 2px; padding: .38rem .65rem;
}
.tlp-search i { color: rgba(255,255,255,.3); font-size: .75rem; }
.tlp-input {
  flex: 1; background: transparent; border: none; outline: none;
  font-family: 'Source Serif 4', serif; font-size: .78rem; color: #fff;
}
.tlp-input::placeholder { color: rgba(255,255,255,.25); font-style: italic; }

.track-list { list-style: none; margin: 0; padding: .35rem 0; }
.track-item {
...
.ti-wave span {
  display: block; width: 3px; border-radius: 1px; background: var(--gold);
...
.album-spin.spinning { animation: vinyl-spin 8s linear infinite; }
...
.album-center {
  ...
  background: var(--dark); border: 2px solid rgba(196,146,42,.5);
}
.album-glow {
...
.player-title {
  font-family: 'Playfair Display', serif;
  font-size: 1.25rem; font-weight: 900; color: #fff; margin: 0; line-height: 1.2;
}
...
.progress-thumb {
  ...
  background: var(--gold-l); box-shadow: 0 0 6px var(--gold);
  transition: left .3s;
}
...
.pc-btn {
  ...
  font-size: 1rem; cursor: pointer; padding: .35rem; border-radius: 50%;
...
.pc-btn.play-btn {
  ...
  background: var(--gold); color: #fff; font-size: 1.1rem;
  transition: background .2s, transform .2s;
}
.pc-btn.play-btn:hover { background: var(--gold-l); transform: scale(1.06); }
...
.pe-btn {
  ...
  font-size: .82rem; cursor: pointer; padding: 0; transition: color .2s;
}
...
.speed-btn {
  background: rgba(255,255,255,.06); border: 1px solid rgba(255,255,255,.1);
  color: rgba(255,255,255,.45); font-size: .68rem; padding: .15rem .45rem;
  border-radius: 1px; cursor: pointer; transition: all .18s;
...
.pa-btn {
  ...
  background: rgba(255,255,255,.06); border: 1px solid rgba(255,255,255,.1);
  color: rgba(255,255,255,.55); font-family: 'Source Serif 4', serif;
  font-size: .72rem; padding: .35rem .75rem; border-radius: 1px;
...
.tp-header-left i { font-size: .8rem; }
.tp-header-right { display: flex; align-items: center; gap: 1rem; }
...
.fc-btn {
  background: #fff; border: 1.5px solid var(--border); border-radius: 1px;
  color: #7a6a52; font-size: .72rem; font-weight: 700; padding: .18rem .5rem;
...
.text-line {
  ...
  padding: .3rem .5rem; border-radius: 2px; margin-bottom: .15rem;
...
.text-word {
  color: var(--ink); cursor: default; transition: color .15s;
  font-style: italic;
}
.text-word.hard {
  color: var(--rust);
  ...
  padding: 0 .1rem; border-radius: 1px;
}
...
.gloss-card {
  ...
  background: var(--dark); border: 1px solid rgba(196,146,42,.35);
  border-radius: 3px; padding: 1rem 1.1rem;
  box-shadow: 0 8px 32px rgba(0,0,0,.25);
  z-index: 20; cursor: pointer;
  animation: gloss-in .25s ease;
}
@keyframes gloss-in { from { opacity:0; transform:translateY(8px) } to { opacity:1; transform:none } }
...
.gloss-close  { background: none; border: none; color: rgba(255,255,255,.4); cursor: pointer; font-size: .8rem; padding: 0; }
...
.gloss-tag {
  ...
  color: var(--gold); background: rgba(196,146,42,.12);
  padding: .15rem .5rem; border-radius: 1px; border: 1px solid rgba(196,146,42,.25);
}
...
.wf-bar.active { animation: wf-anim 1.2s ease-in-out infinite; }
@keyframes wf-anim {
...
.empty-player {
  ...
  background: var(--dark); border-radius: 4px; border: 1px solid rgba(196,146,42,.15);
}
.ep-icon { width: 64px; height: 64px; border-radius: 50%; background: rgba(196,146,42,.1);
  display: flex; align-items: center; justify-content: center; }
